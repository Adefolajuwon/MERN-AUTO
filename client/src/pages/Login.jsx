			...
			{!success && (
				<div className="w-full sm:w-2/5  h-auto bg-slate-100 rounded-[5px] flex justify-start flex-col items-center py-6">
					...
					<form action="" className="w-4/5 h-auto mt-2" onSubmit={logInAccount}>
						...
						<button className="w-full h-10 text-[12px] bg-white text-black flex justify-center items-center rounded-[5px] my-3">Log In</button>
					</form>
					...
					<div className="h-auto mt-4 flex gap-3">
						<p className="text-[12px]">
							...
							<Link to="/register" className="text-blue-400 ml-2 hover:underline hover:cursor-pointer">
								Sign Up
							</Link>
						</p>
					</div>
